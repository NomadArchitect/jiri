...
func (g *Git) SubmoduleUrl(name string) (string, error) {
	...
	if got, want := len(out), 1; got != want {
		return "", fmt.Errorf("SubmoduleUrl: unexpected length of remotes %v: got %v, want %v", out, got, want)
	}
	return out[0], nil
}
...
// If ran under submodule directory, the directories of other submoudles will be
