...
See the jiri [filesystem docs](https://fuchsia.googlesource.com/jiri/+/HEAD/FILESYSTEM.doc).

## Manifests<a name="manifests"></a>

See the jiri [manifest docs](https://fuchsia.googlesource.com/jiri/+/HEAD/MANIFEST.doc).
...
see [Jiri local update](https://fuchsia.googlesource.com/jiri/+/HEAD/HACKING.md)
-->
