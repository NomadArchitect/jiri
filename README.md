...
of golang should be installed. After setting up environment variable $GOPATH,
you can build jiri from its latest source code using command:
...
directory. If you make any modification to your local source and would like to rebuild
jiri, you can use following command:
