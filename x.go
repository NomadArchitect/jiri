...
func init() {
	...
	flag.UintVar(&timeLogThresholdFlag, "time-log-threshold", 10, "Log time taken by operations if more than the passed value(in seconds). This only works with -v and -vv.")
