...
func newCmdCL() *cmdline.Command {
	return &cmdline.Command{
		...
		Children: []*cmdline.Command{cmdCLCleanup, cmdCLUpload, cmdCLNew, cmdCLPatch, cmdCLSync},
	}
}
...
// Use a factory to avoid an initialization loop between between the
// Runner function and the ParsedFlags field in the Command.
func newCmdCLUpload() *cmdline.Command {
	return &cmdline.Command{
		Runner: jiri.RunnerFunc(runCLUpload),
		Name:   "upload",
