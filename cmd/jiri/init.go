...
func init() {
	...
	cmdInit.Flags.StringVar(&optionalAttrs, "optional-attributes", optionalAttrsNotSet, "Set up attributes of optional projects and packages that should be fetched by jiri.")
}
