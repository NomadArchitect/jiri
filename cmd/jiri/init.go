...
func runInit(env *cmdline.Env, args []string) error {
	...
	if gitConfigSubmInfraOnly, err := jiri.GitGetConfig("jiri.forceDisableSubmodulesInfraOnly"); err == nil {
		if isForceDisable, err := strconv.ParseBool(gitConfigSubmInfraOnly); err != nil {
