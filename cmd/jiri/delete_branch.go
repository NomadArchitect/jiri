...
//func getDeleteBranch(jirix *jiri.X, local project.Project, remote project.Project) (string, string, error) {
//	revision := ""
//	git := gitutil.New(jirix.NewSeq(), gitutil.RootDirOpt(local.Path))
//	changes := ""
//	if deleteBranchFlags.changes {
//		var err error
//		changes, err = git.ShortDeleteBranch()
//		if err != nil {
//			return "", "", err
//		}
//	}
//	if deleteBranchFlags.notHead && remote.Name != "" {
//		if headRev, err := project.GetHeadRevision(jirix, remote); err != nil {
//			return "", "", err
//		} else {
