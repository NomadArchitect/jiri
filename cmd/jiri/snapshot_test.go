...
func TestSnapshot(t *testing.T) {
	...
	if err := project.UpdateUniverse(fake.X, true, false, false, false, project.DefaultConcurrentFetches); err != nil {
		t.Fatalf("%v", err)
	}
	...
	if err := project.UpdateUniverse(localX, true, false, false, false, project.DefaultConcurrentFetches); err != nil {
		t.Fatalf("%v", err)
	}
	for i, _ := range remoteProjects {
		localProject := filepath.Join(fake.X.Root, localProjectName(i))
