...
func deleteMergedBranches(jirix *jiri.X, branchToDelete string, deleteMergedCls bool) error {
	...
	processProject := func(key project.ProjectKey) {
		...
		if deleteMergedCls {
			...
			deletedBranches = append(deletedBranches, deletedBranches2...)
...
func deleteProjectMergedClsBranches(jirix *jiri.X, local project.Project, remote project.Project, relativePath, branchToDelete string) ([]string, MultiError) {
...
func deleteProjectMergedBranches(jirix *jiri.X, local project.Project, remote project.Project, relativePath, branchToDelete string) ([]string, MultiError) {
	deletedBranches := []string{}
	var retErr MultiError
