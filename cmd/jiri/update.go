...
func init() {
	...
	cmdUpdate.Flags.BoolVar(&showUpdateLogsFlag, "showUpdateLogs", false, "Show all update logs.")
...
func runUpdate(jirix *jiri.X, _ []string) error {
	...
	updateFn := func() error { return project.UpdateUniverse(jirix, gcFlag, showUpdateLogsFlag) }
