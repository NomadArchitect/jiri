...
func (g *Git) HasUncommittedChanges() (bool, error) {
	...
	unCommitedFlag := git2go.StatusWtModified | git2go.StatusWtDeleted | git2go.StatusWtTypeChange | git2go.StatusIndexModified |
		git2go.StatusIndexNew | git2go.StatusIndexDeleted | git2go.StatusIndexTypeChange | git2go.StatusConflicted
