...
// syncProjectMaster checks out latest detached head if project is on one; else
// it rebases current branch onto its tracking branch. This may succeed
// partially with errPartialSuccess.
