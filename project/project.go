...
var (
	...
	DefaultPackagesTimeout = uint(5) // DefaultPackagesTimeout is the time in minutes to wait for cipd fetching packages
)
...
func CreateSnapshot(jirix *jiri.X, file string, hooks Hooks, packages Packages, localManifest bool) error {
...
func WriteUpdateHistorySnapshot(jirix *jiri.X, snapshotPath string, hooks Hooks, localManifest bool) error {
	...
	if err := CreateSnapshot(jirix, snapshotFile, hooks, nil, localManifest); err != nil {
		return err
	}
