...
func (m *Manifest) ToFile(jirix *jiri.X, filename string) error {
	...
	m.Projects = projects
	sort.Sort(PackagessByKey(m.Packages))
...
// PackagessByKey implements the Sort interface. It sorts Packages by
// the synthesized PackageKey.
type PackagessByKey []Package

func (packages PackagessByKey) Len() int {
	return len(packages)
}
func (packages PackagessByKey) Swap(i, j int) {
	packages[i], packages[j] = packages[j], packages[i]
}
func (packages PackagessByKey) Less(i, j int) bool {
