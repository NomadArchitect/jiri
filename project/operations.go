...
// errPartialSuccess is a sentinel error indicating that an operation did not complete fully but should not abort other operations.
// This can happen because a project was configured to be excluded from the operation, or because an operation requires manual intervention to be completed.
...
type operation interface {
	...
	Kind() string
	// Run executes the operation. Operations may complete with partial success, in which case Run should return errPartialSuccess.
