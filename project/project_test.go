...
func testLocalBranchesAreUpdated(t *testing.T, shouldLocalBeOnABranch, rebaseAll bool) {
	...
	if err := project.UpdateUniverse(fake.X, false, false, false, false, rebaseAll); err != nil {
		t.Fatal(err)
	}
...
func TestFileImportCycle(t *testing.T) {
	...
	err := project.UpdateUniverse(jirix, false, false, false, false, false)
...
func TestRemoteImportCycle(t *testing.T) {
	...
	// The update should complain about the cycle.
	err := project.UpdateUniverse(fake.X, false, false, false, false, false)
