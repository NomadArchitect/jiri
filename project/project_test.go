...
func TestFileImportCycle(t *testing.T) {
	...
	err := project.UpdateUniverse(jirix, project.UpdateFlags{Gc: false, ShowUpdateLogs: false, UseLocalManifest: false})
...
func TestRemoteImportCycle(t *testing.T) {
	...
	// The update should complain about the cycle.
	err := project.UpdateUniverse(fake.X, project.UpdateFlags{Gc: false, ShowUpdateLogs: false, UseLocalManifest: false})
