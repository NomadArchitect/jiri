...
func TestUpdateUniverseWhenLocalTracksLocal(t *testing.T) {
	...
	if err := project.UpdateUniverse(fake.X, false, false, false, false, true /*rebase-all*/, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout); err != nil {
		t.Fatal(err)
	}
...
func TestRecursiveImportWithLocalImport(t *testing.T) {
	...
	if err := project.UpdateUniverse(fake.X, false, true /* localManifest */, false, false, false, false, false, project.DefaultHookTimeout, project.DefaultPackagesTimeout); err != nil {
		t.Fatal(err)
	}
...
func TestRunHookFlag(t *testing.T) {
	...
	if err := project.UpdateUniverse(fake.X, false, false, true /*rebaseTracked*/, false, false, false /*run-hooks*/, false /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout); err != nil {
		t.Fatal(err)
	}
}
...
func TestUpdateWhenRemoteChangesRebased(t *testing.T) {
	...
	if err := project.UpdateUniverse(fake.X, false, false, true /*rebaseTracked*/, false, false, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout); err != nil {
		t.Fatal(err)
	}
...
func testCheckoutSnapshot(t *testing.T, testURL bool) {
	...
	if testURL {
		...
		project.CheckoutSnapshot(fake.X, server.URL, false, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout)
	} else {
		project.CheckoutSnapshot(fake.X, snapshotFile, false, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout)
	}
...
func testLocalBranchesAreUpdated(t *testing.T, shouldLocalBeOnABranch, rebaseAll bool) {
	...
	if err := project.UpdateUniverse(fake.X, false, false, false, false, rebaseAll, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout); err != nil {
		t.Fatal(err)
	}
...
func TestFileImportCycle(t *testing.T) {
	...
	err := project.UpdateUniverse(jirix, false, false, false, false, false, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout)
...
func TestRemoteImportCycle(t *testing.T) {
	...
	// The update should complain about the cycle.
	err := project.UpdateUniverse(fake.X, false, false, false, false, false, true /*run-hooks*/, true /*run-packages*/, project.DefaultHookTimeout, project.DefaultPackagesTimeout)
