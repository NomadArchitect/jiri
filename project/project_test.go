...
func TestFileImportCycle(t *testing.T) {
	...
	err := project.UpdateUniverse(jirix, false, false, false, false, project.DefaultConcurrentFetches)
...
func TestRemoteImportCycle(t *testing.T) {
	...
	// The update should complain about the cycle.
	err := project.UpdateUniverse(fake.X, false, false, false, false, project.DefaultConcurrentFetches)
