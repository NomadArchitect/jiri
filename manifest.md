...
* platforms (optional) - The "platforms" attribute specifies the platforms supported by the package. By default, it is set to "linux-amd64,mac-amd64". However, if this package supports other platforms, e.g. linux-arm64, this attribute needs to be explicitly defined.
